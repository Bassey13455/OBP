...
const validationRules = require("./validations/PDPEventsValidationRules");
   ...
   if (failures.length > 0) {
     ...
     failures.forEach((fail) => {
      ...
      await validationWorkbook.xlsx.writeFile(
        "PDPEvents_validation_summary.xlsx"
      );
      console.log(
        "💾 Saved Validation Summary → PDPEvents_validation_summary.xlsx"
      );
    }
...
async function exportPartialResults(workbook) {
  ...
  await adobeWorkbook.xlsx.writeFile("PDPEvents_adobe_hits_partial.xlsx");
  await ga4Workbook.xlsx.writeFile("PDPEvents_ga4_hits_partial.xlsx");
  await cjaWorkbook.xlsx.writeFile("PDPEvents_cja_hits_partial.xlsx");

  console.log("💾 Saved partial Adobe → PDPEvents_adobe_hits_partial.xlsx");
  console.log("💾 Saved partial GA4 → PDPEvents_ga4_hits_partial.xlsx");
  console.log("💾 Saved partial CJA → PDPEvents_cja_hits_partial.xlsx");
}
  ...
  await adobeWorkbook.xlsx.writeFile("PDPEvents_adobe_hits_per_step.xlsx");
  await ga4Workbook.xlsx.writeFile("PDPEvents_ga4_hits_per_step.xlsx");
  await cjaWorkbook.xlsx.writeFile("PDPEvents_cja_hits_per_step.xlsx");

  console.log("💾 Saved Adobe → PDPEvents_adobe_hits_per_step.xlsx");
  console.log("💾 Saved GA4 → PDPEvents_ga4_hits_per_step.xlsx");
  console.log("💾 Saved CJA → PDPEvents_cja_hits_per_step.xlsx");
  await browser.close();
})();
